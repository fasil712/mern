...
Welcome to our MERN ([MongoDB](https://www.mongodb.com/){:target="_blank"}, [Express.js](https://expressjs.com/){:target="_blank"}, [React](https://react.dev/){:target="_blank"}, [Node.js](https://nodejs.org/en){:target="_blank"}) eCommerce Application repository!<a href="LICENSE" target="_blank">LICENSE</a>
